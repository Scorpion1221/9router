...
// 3. role "system"/"developer" messages (mid-conversation-system beta) → folded as instruction text
...
export function normalizeClaudePassthrough(body, model = "") {
  ...
  // 2. Fold mid-conversation system/developer messages into the neighbouring turn.
