 ...
 */
export async function handleComboChat({ body, models, handleSingleModel, log, comboName, comboStrategy, comboStickyLimit = 1, probeStreamFirstByte = true, probeTimeoutMs, autoSwitch = true }) {
