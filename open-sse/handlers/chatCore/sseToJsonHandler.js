...
function chatCompletionToResponses(responseBody, customToolNames = null, namespaceTools = null) {
 ...
 */
export async function handleForcedSSEToJson({ providerResponse, sourceFormat, targetFormat, provider, model, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, clientRawRequest, onRequestSuccess, customToolNames, namespaceTools, toolNameMap, trackDone, appendLog, reqTag, log }) {
  ...
  try {
    ...
    const finalBody = sourceFormat === FORMATS.OPENAI_RESPONSES
      ? chatCompletionToResponses(parsed, customToolNames, namespaceTools)
      : parsed;
