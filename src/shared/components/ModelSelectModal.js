  ...
  const groupedModels = useMemo(() => {
    ...
    sortedProviderIds.forEach((providerId) => {
      ...
      if (providerInfo.passthroughModels) {
        ...
        // Prefer account-native catalogs, then the shared live/static catalog.
    ...
    return groups;
  }, [filteredActiveProviders, modelAliases, allProviders, providerNodes, customModels, disabledModels, kindFilter, activeProviders, modelsByProvider, cursorModels, clineModels, clinepassModels]);
