  ...
  const groupedModels = useMemo(() => {
    ...
    sortedProviderIds.forEach((providerId) => {
      ...
      if (providerInfo.passthroughModels) {
        ...
        // entries (e.g. claude-opus-4-8) appear without a redeploy. Cursor uses
        // the connected account's live catalog when it is available.
    ...
    return groups;
  }, [filteredActiveProviders, modelAliases, allProviders, providerNodes, customModels, disabledModels, kindFilter, activeProviders, modelsByProvider, cursorModels]);
