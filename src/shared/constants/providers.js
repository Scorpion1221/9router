...
export const APIKEY_PROVIDERS = {
  ...
  azure: { id: "azure", alias: "azure", name: "Azure OpenAI", icon: "cloud", color: "#0078D4", textIcon: "AZ", website: "https://azure.microsoft.com/en-us/products/ai-services/openai-service", notice: { apiKeyUrl: "https://portal.azure.com/#view/Microsoft_Azure_ProjectOxford/CognitiveServicesHub/~/OpenAI" }, hasProviderSpecificData: true, serviceKinds: ["llm", "image"], imageConfig: { baseUrl: "https://{azureEndpoint}/openai/deployments/{deployment}/images/generations", authType: "apikey", authHeader: "api-key" } },
